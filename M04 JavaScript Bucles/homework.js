...
function fizzBuzz(num) {
   ...
   var divTres
   var divCinco
   if (num % 3 === 0) divTres = true;
   else divTres = false;
   if (num % 5 === 0) divCinco = true;
   else divCinco = false;
   if (divTres && divCinco) return "fizzbuzz";
   else if (divCinco) return "buzz";
   else if (divTres) return "fizz"
   else return false;
}
...
function tieneTresDigitos(num) {
   ...
   // Tu código:
   var numaux = Math.floor(num);
   for (var i = 10; i <= 10000; i = i * 10) {
      if (Math.floor(numaux/ i) == 0) {
